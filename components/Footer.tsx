import ExternalHyperlinkText from "./nav/ExternalHyperlinkText";
  ...
  return (
    <footer className="flex items-center justify-between w-full h-auto p-3">
      ...
      <div className="flex flex-col items-center justify-center gap-2">
        <a
          data-label="Share Feedback & Ideas"
          href="https://forms.gle/2HhKAsX91FLnzYGV7"
          target="_blank"
          rel="noreferrer"
...
const BuyMeACoffee: React.FC = () => {
  return (
    ...
    >
      <div className="hover:animate-wiggle group-focus:animate-wiggle">
        <svg
          className="w-6 h-6 stroke-[#ffdd00]"
          viewBox="0 0 24 24"
          strokeWidth="2"
          strokeLinecap="round"
